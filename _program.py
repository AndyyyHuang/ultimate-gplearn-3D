...
'''
The gplearnRPC._program module mainly contains the design for how to construct genetic algorithm expressions. Its main purpose is to create and evolve expressions.
This file mainly designs the specific structure for building expressions. For specific genetic, variation and mutation schemes, please refer to gplearnRPC.genetic
Author: Shawn_RPC
'''
